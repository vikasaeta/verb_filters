...
lineList = [line for line in open(r'results_resume.tsv', 'r', encoding='utf-8')]
...
for s in range (1,len(lineList)):
    ...
    if not (fl.isGerund(my_split) or fl.isAdjective(my_split, my_tokens,tagged_tokens, formlist) or fl.hasGerundAfter(my_split, my_tokens) or fl.isIntransitive(my_split, tagged_tokens)):
